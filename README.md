...
- **⏰ Automated & On-Demand Cadence:** Configured via `vercel.json` to trigger scheduled updates autonomously (once per day on free tiers or hourly on Pro tiers) alongside instant manual web triggers.
